...
## 🏗️ Все еще нет компонентной модели
Вместо этого жонглирование сервисами и контроллерами  

## 🏗️ Крайне слабая производительность
...
<div class="box box--rich">React иммет реактивность UI, но не имеет реактивной системы</div>
