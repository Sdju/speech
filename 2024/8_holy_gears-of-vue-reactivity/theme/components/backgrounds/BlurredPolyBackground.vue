  ...
  >
    <div
      ...
      :style="{
        ...
        'opacity': opacity,
        'background-image': `linear-gradient(to right, var(--bg-first) 0%, #FFFFFF10 100%)`
      }"
    />
    <div
      class="clip"
      :style="{
        ...
        'opacity': opacity,
        'background-image': `linear-gradient(to right, var(--bg-second) 0%, #FFFFFF10 100%)`
      }"
    />
    <div
      class="clip"
      :style="{
        ...
        'opacity': opacity,
        'background-image': `linear-gradient(to right, var(--bg-third) 0%, #FFFFFF10 100%)`
      }"
    />
  </div>
  <DitherImg />
