...
<!--
Всем привет. Я Чернов Денис и посвятил разработке уже более 12 лет. Из них 10 отдал JavaScript-у. 

И знаете что? Я все еще его не знаю. Как бы я не любил этот язык и как бы много времени ему не посвящал он все еще находит чем бы меня удивить.
-->
...
<!--
Цель данного доклада побольше узнать о разных сторонах JavaScript

Понять как можно подходить к изучению и восприятию JavaScript с разных сторон

И главное сегодня не столько дать готовые ответы, сколько заставить вас задавать себе и другим вопросы: а точно ли я понимаю как работает JavaScript на самом деле
-->
...
<!--
Ну и начнем мы с такой цитаты от создателя формата JSON Дугласа Крокфорда: Самый неправильно понятый язык программирования в мире стал самым популярным в мире языком программирования.
-->
...
<!--
И чтобы дополнить картинку добавлб еще одну цитату от Кайла Симпсона, автора серии книг You Don't Know JS: Я подчеркиваю Путешествие, потому что знание JS не является пунктом назначения, это направление.

Как мы видим, нельзя в один момент сказать, что ты знаешь JS. Это скорее витиеватый путь по которому можно бесконечно блуждать в поисках верного направления.
-->
...
<!--
Главный вывод к которому я сегодня пытаюсь вас подтолкнуть: JavaScript не существует в единственной форме?

Но как понять это выражение? Чтобы лучше его осознать давайте разберемся, а что же за формы JavaScript вообще существуют?
-->
...
<!--
И здесь мы видим айсберг погружения в глубины JavaScript.

Верхние 2 уровня это зона с которой абсолютное большинство тут знакомо. Тут нет ничего неожиданного. 
Все мы можем использовать так или иначе JavaScript на практике. Уверен, что многие готовы даже к этапу прохождений собеседований. Кто-то более увлеченный ныряет чуть поглубже штрудируя мануалы на MDN.

Стоит отметить, что это основные уровни погружения в JavaScript. Погружения еще глубже несут в себе некоторые сложности и достаточно специфичны. Не всем они могут пригодиться в полной мере. Поэтому я считаю нормальным, что эта часть находится глубже, там куда попадют лишь те, кто в этом действительно заинтересован.

Встречают нас 2 уровня со спецификациями. На которых мы сталкиваемся со скучными документами, которые не особо ставят целью вас чему-то научить. Здесь уже вы сами ищите то что вам необходимо.

Однако еще ниже расположились уровни связанные с движками. Они могут быть разными и очень изменчивыми. Будьте готовы к тому что некоторые действительно будут сложными, а информацию находить будет еще сложнее

И вот на самом дне мы достигаем просветвления и можем в полной мере применять все то что накопилось выше. И тут будет лежать невероятнейшая разница между самым верзним уровнем и самым нижним, несмотря на такое сходство.

Однако давайте начнем наше погружение постепенно. Заново рассмотрев каждый слой поподробнее, чтобы сформировать свою картину
-->
...
<!--
И вначале нас встречает "Мифический JavaScript". Почему этот слой именно мифический? 

Тут есть некоторая доля иронии, ведь этот уровень наиболее практичный и "реальный" из всех других. Именно с ним мы ежедневно сталкиваемся на работе. Но что же с ним не так? Так как это зона минимального погружения, то и знания и навыки тут будут наиборлее поверхностными. Тем самым порождая множество мифов.

Давайте кратко пробежимся по уровням этого слоя:
Прагматичный JavaScript. Как уже и говорилось это тот самый JavaScript который мы еженевно используем на работе.

Далее у нас JavaScript с собеседований. Зона наибольших мифов. Когда сказания передаются от собеседующих к собеседуемым. 

Ну и последний уровень. Это то как мы учим JavaScript. Тут мы порой ныряем то глубже, то как губка впитываем информацию не особо фильтруя источники.
-->
...
<!--
Далее у нас расположился "Задокументированный JavaScript". Как можно догадаться, то тут речь идет уже больше о официальных документах и спецификациях. Сюда редко нужно опускаться всем специалистам. Чаще всего у вас будут какие-то более специфичные задачи, когда важно документально в чем-то удоствериться

И вот главный этап: JavaScript согласно EcmaScript. Это буквальнго закреплено как JavaScript должен
-->
