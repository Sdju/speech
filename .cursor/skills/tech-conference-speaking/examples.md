...
Спикер проговаривает:
- мы не будем обсуждать "как писать composables с нуля"
- мы обсуждаем критерии качества и границы применимости
Переход: после этого можно вводить рабочее определение composable.
-->
...
- 1 короткий тезис
- 1 контрпример
- 1 обещание: позже уточним через реальные кейсы
-->
```
