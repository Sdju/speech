import{d,a9 as u,y as h,b as a,e as t,x as s,A as r,F as v,a7 as f,o as n,aa as g,l as x,g as b}from"../modules/vue-DWLVE48c.js";import{u as y,j as N,c as m,b as k}from"../index-Rr6RXTWx.js";import{N as w}from"./NoteDisplay-Drih9ULj.js";import"../modules/shiki-cMibciSt.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},C={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),A={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){const{slides:p,total:_}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
