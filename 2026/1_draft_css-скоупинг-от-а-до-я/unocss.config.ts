...
const variants = {
  ...
  'dt-default': "[--bg-keyword:#9cdcfe] [--bg-first:#3c4043] [--bg-second:#4a4d51] [--bg-third:#5f6368] [--v-color:#9cdcfe] ",
  'dt-leak': "[--bg-keyword:#f48771] [--bg-first:#5a2d2d] [--bg-second:#7a3d3d] [--bg-third:#9a4d4d] [--v-color:#f48771] ",
  'dt-scope': "[--bg-keyword:#9cdcfe] [--bg-first:#264f78] [--bg-second:#3794ff] [--bg-third:#4fc1ff] [--v-color:#9cdcfe] ",
  'dt-shadow': "[--bg-keyword:#b180d7] [--bg-first:#4a2d5a] [--bg-second:#6b3d8a] [--bg-third:#8b4daa] [--v-color:#b180d7] ",
  'dt-build': "[--bg-keyword:#6a9955] [--bg-first:#2d4a2d] [--bg-second:#3d6a3d] [--bg-third:#4d8a4d] [--v-color:#6a9955] ",
  'dt-utility': "[--bg-keyword:#dcdcaa] [--bg-first:#5a5a2d] [--bg-second:#7a7a3d] [--bg-third:#9a9a4d] [--v-color:#dcdcaa] ",
  'dt-cascade': "[--bg-keyword:#4ec9b0] [--bg-first:#2d4a4a] [--bg-second:#3d6a6a] [--bg-third:#4d8a8a] [--v-color:#4ec9b0] ",
}
